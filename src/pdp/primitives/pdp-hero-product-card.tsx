  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-2">
        <p className="font-extended text-balance text-[18px] leading-[1.15] text-black">
          {PDP_PRODUCT_CARD.lineOneLeft}
        </p>
        <p className="font-extended text-balance text-right text-[18px] leading-[1.15] text-black">
