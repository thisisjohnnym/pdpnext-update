...
/** Shared — vertical page scroll passes through card content; track handles horizontal */
const pdpCarouselItemTouchClass = "touch-pan-y";

export const pdpCarouselScrollClass = cn(
  "pdp-carousel-scroll overflow-x-auto overscroll-x-contain pb-1",
...
export const pdpCompareCarouselCardClass = cn(
...
export const pdpReviewPhotoCardClass = cn(
...
export const pdpUgcStoryCardClass = cn(
...
export const pdpUgcVideoCardClass = cn(
...
export const pdpUgcVideoCardCenteredClass = cn(
...
export const pdpCarouselInfiniteCenteredScrollClass = cn(
  "pdp-carousel-scroll w-full overflow-x-auto overscroll-x-contain pb-1",
  "[-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden",
...
export const pdpAsSeenOnCardClass = cn(
...
export const pdpAsSeenOnCardCompactClass = cn(
...
export const pdpDiscoveryInnerScrollClass =
  "pdp-carousel-scroll overflow-x-auto overscroll-x-contain snap-x snap-mandatory [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden";

export const pdpDiscoveryRailCardClass = cn(
  "w-[calc((100%-0.5rem)/2.05)] shrink-0 snap-start snap-always",
  pdpCarouselItemTouchClass,
);

export const pdpDiscoverySimilarCardClass = cn(
  "w-[calc((100%-0.5rem)/2.2)] shrink-0 snap-start snap-always lg:w-[calc((100%-0.75rem)/3)]",
  pdpCarouselItemTouchClass,
);

/** Carousel photos — don't intercept touch; parent card handles pan-y */
